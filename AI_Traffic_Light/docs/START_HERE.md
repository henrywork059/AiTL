...
ESP -> ATL1 header + JPEG
    -> V037 adaptive JPEG pressure control
...
For new profiles start at **320 × 240, JPEG 24, 15 FPS**. V037 may temporarily raise the JPEG quality number (more compression) when the link is under pressure and later step back toward the saved quality when delivery becomes fast.
