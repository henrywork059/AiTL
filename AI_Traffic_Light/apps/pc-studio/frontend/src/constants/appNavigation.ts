...
export const APP_VERSION_LABEL = "0_1_7 convergence + prototype tools";
...
export const PAGE_DETAILS: Record<AppPageId, AppPageSummary> = {
  ...
  live_ai: { id: "live_ai", label: "Live AI View", shortLabel: "Live AI", description: "Preview receiver or simulation frames with detections from a selected trained YOLO model.", status: "test-ready" },
  ...
  zone_editor: { id: "zone_editor", label: "Zone Editor", shortLabel: "Zones", description: "Create, edit, persist, and reset pedestrian waiting, crossing, vehicle queue, and ignore zones.", status: "test-ready" },
  ...
  dataset_capture: { id: "dataset_capture", label: "Dataset Capture", shortLabel: "Capture", description: "Persist receiver or simulation images with paired metadata and quality tags.", status: "test-ready" },
  dataset_review: { id: "dataset_review", label: "Dataset Review", shortLabel: "Review / Label", description: "Browse saved frames, draw manual bounding boxes, and build the managed YOLO training dataset.", status: "test-ready" },
