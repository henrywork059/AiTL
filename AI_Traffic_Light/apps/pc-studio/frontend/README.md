...
V037 R2 new-camera defaults are 320 × 240 / JPEG 24 / 15 FPS. The V037 ESP may temporarily raise the effective JPEG quality number to reduce transport pressure while preserving the saved value as the recovery floor.
